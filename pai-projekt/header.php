...
if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
    ...
    $idLogged = $_SESSION["id"];
    $q = "SELECT * FROM users WHERE ID = $idLogged";
    $r = $db->query($q);
    foreach($r as $item) {
        $userLogged = $item['login'];
    }
?>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
      <h5 class="my-0 mr-md-auto font-weight-normal"><a class="p-3 text-dark">Witaj, <?php echo $userLogged; ?> </a></h5>
