...
<div class="container-fluid text-center text-primary jumbotron jumbotron-fluid bg-white" style="margin-top:70px;">
    <h1><small>Twoje zdrowie jest dla nas ogromnie ważne!</small></h1> <br>
    <h2 class="mt-4 mb-4"><small>Dlatego pragniemy Ci przedstawić aplikację do kontroli swojego ciała</small></h2><br>
    <span class="display-4 mt-4">To jeszcze nigdy nie było takie łatwe!</span>

</div>
<div class="bg-primary container-fluid text-center text-primary jumbotron jumbotron-fluid lead">
    <span class="text-white lead" style="font-size: 25px;">Korzystanie z naszej aplikacji jest możliwe będąc Gościem.</span><br>
    ...
    <span class="text-white lead m-4" style="font-size: 25px;">Mimo to zalecamy zalogowanie się w celu uzyskania dodatkowych funkcji!</span><br>
...
<div class="bg-white container-fluid text-center text-primary jumbotron jumbotron-fluid lead" id="zalety">
    <span class="display-4 mx-4">Poznaj siebie i budowę człowieka od środka!</span> <br><br>
